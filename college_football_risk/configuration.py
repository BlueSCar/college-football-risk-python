...
class Configuration(object):
    ...
    :param signing_info: Configuration parameters for HTTP signature.
        Must be an instance of college_football_risk.signing.HttpSigningConfiguration
    ...
    You can programmatically set the cookie:
      conf = college_football_risk.Configuration(
    ...
    Note you can use the constants defined in the college_football_risk.signing module, and you can
    ...
    are not going to be modified in transit.
      ...
      conf = college_football_risk.Configuration(
        signing_info = college_football_risk.signing.HttpSigningConfiguration(
            key_id =                 'my-key-id',
    ...
    def __init__(self, host="https://collegefootballrisk.com/api",
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("college_football_risk")
    ...
    def get_host_settings(self):
        ...
        return [
            {
                'url': "https://collegefootballrisk.com/api",
